...
def main(args):
    ...
    iterations = 0
    preds = np.zeros((45000, args.num_novel_class))
    labels = np.zeros(45000)
    flag = 0
    network.eval()
    ...
    labels = labels[:flag]
    args.base_shot = mem
    f = h5py.File('pred/tail_pred_{}_{}.h5'.format(args.model, args.base_shot), 'w')
...
if __name__ == '__main__':
    ...
    args.list_val = 'data_file/{}_{}/tail_label.h5'.format(args.model, args.base_shot)
    # args.list_val = 'data/val_set_{}_{}.h5'.format(args.model, args.base_shot)
    args.model_weight = 'ckpt/{}_{}/net_epoch_{}.pth'.format(args.model, args.base_shot, args.epoch)
